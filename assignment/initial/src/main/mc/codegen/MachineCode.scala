...
abstract class MachineCode {
  ...
  def emitIOR() :String
  def emitIREM():String
  def emitFREM():String //added by ledinhtri
  ...
  def emitFCMPG():String //added by ledinhtri
...
class JasminCode extends MachineCode {
	...
	override def emitFREM() = INDENT + "frem" + END
  ...
  override def emitANEWARRAY(lexeme:String) = INDENT + "anewarray " + lexeme + END
	...
	override def emitFCMPG() = INDENT + "fcmpg" + END //added by ledinhtri
